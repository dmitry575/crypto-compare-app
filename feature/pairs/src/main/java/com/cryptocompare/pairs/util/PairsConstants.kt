...
object PairsConstants {
    ...
    object ComparisonScreen {
        ...
        /**
         * Как часто экран сверяет возраст котировок, даже если тиков нет. Строка
         * гаснет с опозданием не больше этого — против пяти минут порога это ничто.
         */
        const val STALENESS_RECHECK_MS = 10_000L
    ...
    object Chart {
        ...
        /**
         * Сколько графиков (биржа × масштаб) экран пары держит в памяти. Возврат
         * к недавнему не идёт в сеть, а старые вытесняются: вместе с [MAX_CANDLES]
         * это потолок памяти экрана — до ~18 тысяч свечей вместо сотен тысяч.
         */
        const val MAX_CACHED_CHARTS = 6
