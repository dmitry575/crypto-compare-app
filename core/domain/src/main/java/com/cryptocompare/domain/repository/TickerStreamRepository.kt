...
interface TickerStreamRepository {
    ...
    /**
     * Экран забирает подписки себе: слотов у соединения мало, и делить их между
     * каталогом и тем, что открыто поверх него, не из чего. Деталям и сравнению
     * нужен один тикер, портфелю — тикеры его позиций.
     *
